...
public class Exam {
	public static void main(String[] args) {
        ...
        do
        {
            ...
            if(ch==4)
            {
                System.out.println("Thank you for ateempting all the questions in exam");
                break;
            }
            switch(ch)
            {
                case 1:
                {
                    ...
                    if(sub==2)
                    {
                        ...
                        System.out.println("5. Which of the following user-defined header file extension used in c++?");
                    ...
                    else
                    {
                        ...
                        System.out.println("Q.5.which extension is used to save executable file?");
                   ...
                   System.out.print("you have succesfully attempted all the questions");
                    }
